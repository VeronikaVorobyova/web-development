...
<?php
require_once $_SERVER['DOCUMENT_ROOT'] . "/mysite/wp-content/themes/mytheme/templates/header.php";
...
<main class="reg_content">
    ...
    <?php } else header("Location: http://127.0.0.1/mysite/wp-content/themes/mytheme/index.php"); ?>
</main>
